...
Add the mongodb repository to the system. */etc/yum.repos.d/mongodb-org-4.2.repo*
...
Change the database server IP address to the address of your database server.

* Start the app

Test that the app is running from the command line *sudo npm start*
Open the URL of the server to check the web site
