...
** Open the *<ssh-access.pem>* file you downloaded earlier (the name will be different), which you have downloaded during module 0, with a text editor and copy the whole content.
